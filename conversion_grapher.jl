...
conversion(100,120,.01,.12,today()+Day(90),90,today()+Day(30),today()+Day(40),1.5,today(),false)
...
mygrapher2(100,120,-.01,.01,.12,today()+Day(90),90,today()+Day(30),today()+Day(40),1.5,today())
